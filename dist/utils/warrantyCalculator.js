 ...
 */
export function calculateWarrantyStatus(expiryDate) {
 ...
 */
export function calculateWarrantyExpiry(purchaseDate, warrantyMonths) {
 ...
 */
export function isWarrantyExpiringSoon(expiryDate, days = 30) {
